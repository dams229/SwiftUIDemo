...
let meetupData: [Meetup] = load("meetupData.json")
...
func loadRemoteData<T: Decodable>(_ completion: @escaping (T) -> Void) {
    request("https://api.myjson.com/bins/1bmlsf").responseData { response in
